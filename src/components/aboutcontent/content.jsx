      ...
      <div className="about-content">
                  ...
                  <div className="age-mail">
                    <div className="fullname">
                      <p>Name:<span className="detcolor">Eshola Duro</span></p>
                      <p className="botomcolor">Age: <span className="detcolor">25</span></p>
                    </div>
                    <div className="fullmail">
                      <p>Email:<span className="mailcolor">isholah360@gmail.com</span></p>
                      <p className="botomcolor">From: <span className="detcolor">Ibadan, Nigeria.</span></p>
                    </div>
                  </div>
