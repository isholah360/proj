    ...
    return(
        ...
        <div>
            <div className= {navies?"navbar": "nav"} >
                <ul ref={node1}> 
                    <li className="lots" ref={nodea} onClick={show} onMouseLeave={changeAbo}
                    onMouseEnter={chgAbo}>About</li>
                    <li ref={nodeb} onClick={showResume} onMouseLeave={changeResume}
                    onMouseEnter={chgResume}
                    >Resume</li>
                    <li ref={nodec} onClick={showPort} onMouseLeave={changePort}
                    onMouseEnter={chgPort}
                    >Portfolio</li>
                    <li ref={noded} onClick={showBlog} onMouseLeave={changeBlog}
                    onMouseEnter={chgBlog}
                    >Blog</li>
                    <li ref={nodee} onClick={showContact} onMouseLeave={changeCont}
                    onMouseEnter={chgCont}>Contact</li>
                    <li>
           ...
           <button ref={close} className='close' onClick={closer}>close</button>
               <div ref={state} className="inside">
                    <About/>
               </div>
           </div>
           <div ref={showz} className="aboutz">
           <button ref={close} className='close' onClick={closing}>close</button>
               <div ref={statez} className="inside">
                    <Resume/>
               </div>
           </div>
           <div ref={port} className="aboutz">
           <button ref={close} className='close' onClick={closePort}>close</button>
               <div ref={ports} className="inside">
                    <Portfolio/>
               </div>
           </div>
           <div ref={blog} className="aboutz">
           <button ref={close} className='close' onClick={closeBlog}>close</button>
               <div ref={blogIn} className="inside">
                    <Blog/>
               </div>
           </div>
           <div ref={contact} className="aboutz">
           <button ref={close} className='close' onClick={closeContact}>close</button>
